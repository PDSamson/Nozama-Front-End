...
var config = {
  apiOrigins: {
    production: 'https://warm-falls-31149.herokuapp.com',
...
var showOrder = __webpack_require__(37);
...
var onGetProducts = function onGetProducts() {
  api.getProducts().then(ui.onGetProductsSuccess);
  // .catch(ui.onGetProductsFailure)
};

// add product to users cart callback
var onAddProduct = function onAddProduct() {
  var currentId = $(event.target).parent().parent().data('id');
  var item = store.products.filter(function (product) {
...
var onUpdateProduct = function onUpdateProduct(event) {
  ...
  api.updateProduct(data).then(ui.updateSuccess).catch(ui.updateFailure);
};

var onRemoveProduct = function onRemoveProduct(e) {
  e.preventDefault();
  api.deleteProduct($(e.target).parent().data('id')).then(ui.deleteSuccess(e)).catch(ui.deleteFailure);
};

var onUpdateField = function onUpdateField(e) {
  e.preventDefault();
...
var onCreateEvent = function onCreateEvent(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createProduct(data).then(ui.createSuccess).then(onGetProducts).catch(ui.createFailure);
  $('#create-product').children('input').val('');
  $('.url').val('www.jpg');
  $('.stock').val('1');
};

var addProductHandlers = function addProductHandlers() {
...
var onGetOrderProducts = function onGetOrderProducts(productArr) {
  store.myOrder.orderProducts = [];

  var promiseProducts = function promiseProducts(productArr) {
    productArr = productArr.map(function (id) {
      return new Promise(function (resolve, reject) {
        api.findProduct(id).then(resolve).catch(reject);
      });
    });
    return Promise.all(productArr);
  };

  promiseProducts(productArr).then(function (products) {
    $('.order-wrap').append(showOrder({ order: store.myOrder, products: products }));
  }).catch(function () {
    return $('.sign-message').text('Error getting order');
  });
};
...
module.exports = {
  ...
  // onGetSingleProduct,
  addProductHandlers: addProductHandlers,
  onGetOrderProducts: onGetOrderProducts
};
...
var productsEvents = __webpack_require__(8);
var orderEvents = __webpack_require__(38);
...
var store = __webpack_require__(2);
var api = __webpack_require__(9);
var showProductsHtml = __webpack_require__(20);

var deleteSuccess = function deleteSuccess(event) {
...
var updateSuccess = function updateSuccess() {
  ...
  api.getProducts().then(onGetProductsSuccess);
  // .catch(onGetProductsFailure)
};

// Filling update form fields
var findSuccess = function findSuccess(data) {
...
var findFailure = function findFailure() {
  $('.sign-message').text('Product not found');
};

// retrieves product information and calls a function to populate fields
var populateUpdateFields = function populateUpdateFields(id) {
  api.findProduct(id).then(findSuccess).catch(findFailure);
};
...
var onGetProductsSuccess = function onGetProductsSuccess(data) {
  ...
  var showProducts = showProductsHtml({ products: data.products });
...
var getOrderProductSuccess = function getOrderProductSuccess(product) {
  store.myOrder.orderProducts.push(product.product);
  return store.myOrder.orderProducts;
};

var getOrderProductFailure = function getOrderProductFailure() {
...
module.exports = {
  ...
  populateUpdateFields: populateUpdateFields,
  deleteSuccess: deleteSuccess,
  deleteFailure: deleteFailure,
  createSuccess: createSuccess,
  createFailure: createFailure,
  getOrderProductSuccess: getOrderProductSuccess,
  getOrderProductFailure: getOrderProductFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul class=\"product-form\" data-id=\""
    ...
    + "</div>\n    <div class=\"add-resource-product\">\n        <button class=\"add-product-button user-btn\" type =\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Add Product</button>\n    </div>\n    <button class=\"btn admin remove\" type=\"button\" name=\"button\">Remove</button>\n    <button class=\"btn admin update\" type=\"button\" name=\"button\">Update</button>\n  </ul>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"order-display\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <ul>\n    <li>Name: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.product : stack1)) != null ? stack1.name : stack1), depth0))
    + "</li>\n    <li>Price: "
  ...
  return "<div>\n<h4>Date: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.order : depth0)) != null ? stack1.createdAt : stack1), depth0))
    + "</h4>\n<h5>Total: $"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.order : depth0)) != null ? stack1.total : stack1), depth0))
    + "</h5>\n\n\n"
...
var $script = __webpack_require__(43);
...
var checkout = function checkout() {
  var handler = StripeCheckout.configure({
    ...
    token: function token(_token) {
      ...
      };var sendToken = function sendToken(data) {
        return $.ajax({
      ...
      sendToken(tokenData).then(function () {
...
var onSubmitCart = function onSubmitCart() {
  var productArray = store.currentCart.currentProducts;
  ...
  api.submitOrder(store.currentCart.cart).then(ui.submitOrderSuccess).catch(ui.submitOrderFailure);
};

// remove product from users cart
var onRemoveProduct = function onRemoveProduct() {
  var productId = $(event.target).parent().data('id');
  var productArray = store.currentCart.currentProducts;
  store.currentCart.currentProducts = productArray.filter(function (product) {
...
var onShowOrders = function onShowOrders() {
  $('.orders-wrap').html('');
  api.showOrders().then(ui.showOrdersSuccess).catch(ui.showOrdersFailure);
  $('.products-wrap').hide();
  $('.shopping-cart').hide();
  $('#change-password-wrap').hide();
  $('.orders-wrap').show();
...
var addOrderHandlers = function addOrderHandlers() {
...
var showOrders = function showOrders() {
  return $.ajax({
    url: config.apiOrigin + '/orders',
    method: 'GET',
    headers: {
...
var store = __webpack_require__(2);
var orders = __webpack_require__(41);
var cart = __webpack_require__(42);
var prodEvents = __webpack_require__(8);

// show users stored products
var onShowCart = function onShowCart() {
  var data = store.currentCart.currentProducts;
...
var submitOrderSuccess = function submitOrderSuccess() {
...
var submitOrderFailure = function submitOrderFailure() {
  $('.sign-message').text('Order not posted successfully');
};

var showOrdersSuccess = function showOrdersSuccess(data) {
  store.myOrders = data.orders.filter(function (order) {
...
var showOrdersFailure = function showOrdersFailure() {
...
var getOrderFailure = function getOrderFailure(data) {
  $('.sign-message').text('get order failure');
};

var displayOrder = function displayOrder(order) {
  var products = store.myOrder.products;
  store.productIdArr = [];
...
module.exports = {
  ...
  submitOrderSuccess: submitOrderSuccess,
  submitOrderFailure: submitOrderFailure,
  showOrdersSuccess: showOrdersSuccess,
  showOrdersFailure: showOrdersFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"order-display\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <ul>\n    <li>Date: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
    + "</li>\n    <li>Total: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total : stack1), depth0))
    + "</li>\n  </ul>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"cart-product-display\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <ul>\n    <li>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</li>\n    <li>"
  ...
  return ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.products : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<h4>Order total: $"
    + container.escapeExpression(((helper = (helper = helpers.cartTotal || (depth0 != null ? depth0.cartTotal : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"cartTotal","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h4>\n";
},"useData":true,"useBlockParams":true});
